...
@interface AbstractHostsController : NSObject<HostsControllerProtocol> {
	@protected
	NSMutableArray *hostsFiles;
	HostsGroup *hostsGroup;
	NSObject<HostsControllerDelegateProtocol> *delegate;
}

@property (retain) NSMutableArray *hostsFiles;
